...
function hangout(response, request){
  fileServer.serveFile('/simpleHangoutApp.xml', 200, {}, request, response);
}

function myindex(response, request){
    
  fileServer.serveFile('/index.html', 200, {}, request, response);

}

function QnAClient(response, request){
  fileServer.serveFile('/QnAClient.js', 200, {}, request, response);
