 ...
 var QnAClient = function(){
    ...
    return {
        ...
        proposeNewQ : function (question) {
            var self = qaThis;
            console.log("Reaching the function in QnAClient.proposeNewQ!");
            if(!question){
        ...
        qaEmit : function(signal, data){
            console.log("reaching the emit function within QnAClient");
        ...
        **/
        initListeners : function() {
            ...
            //TESTING
            qaThis.qaSocket.on('news', function(data){
                console.log("RECEIVED DATA FROM SERVER!!!!");
                console.log("It was: " + data['hello']);
